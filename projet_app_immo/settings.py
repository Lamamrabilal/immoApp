...
env = environ.Env(
    ...
    DJANGO_DATABASE_URL=(str, 'postgresql://postgres:postgres@localhost:5435/immo_db'),
)
...
ROOT_URLCONF = 'projet_app_immo.urls'
...
WSGI_APPLICATION = 'projet_app_immo.wsgi.application'
